...
{
    public class MovieLLRankRepository : IMovieLLRankRepository
    {
        private const string TableName = "MovieRank";
        private readonly IAmazonDynamoDB _dynamoDbClient;

        public MovieLLRankRepository(IAmazonDynamoDB dynamoDbClient)
        {
        ...
        public async Task UpdateMovie(int userId, MovieUpdateRequest updateRequest)
        {
            var request = new UpdateItemRequest
            {
                ...
                AttributeUpdates = new Dictionary<string, AttributeValueUpdate> // properties wanted to update
                {
